...
email_user = 'username@gmail.com' #Enter email address which will send mail
email_password = 'password1234' #Enter password to email address

sent_from = email_user
to = ['<recipient@gmail.com>'] #Email address where email should be recieved

minutes = 1  #Time between subsequent lookups for vaccines

today = date.today()


__district = "49" #Enter district number.
...
""" % (sent_from, ", ".join(to), subject, body)
	...
	try:
	    ...
	    server.sendmail(sent_from, to2, email_text)
	    server.quit()
